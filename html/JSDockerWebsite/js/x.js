function createContVal() {
    ...
    xhr.open("GET", "http://192.168.1.2/cgi-bin/JSDockerWebsite/py-docker-create-backend.py?contName="+contName+"&contImg="+contImg+"&opt="+value, false);
    xhr.send();
    ...
    xhr1.open("GET", "http://192.168.1.2/cgi-bin/JSDockerWebsite/py-docker-countcont.py", true);
    xhr1.send();
